...
func TestParseStatusInstanceResponse(t *testing.T) {
	...
	var resourceIdList []con.InstanceStatus

	instanceRequest := con.InstanceRequest{"rb_name", "rb_version", "profile123456", "c_region", map[string]string{"generic-vnf-id": "123456789", "vf-module-id": "987654321"}, map[string]string{"generic-vnf-id": "123456789", "vf-module-id": "987654321"}}
	instanceStatus := con.InstanceStatus{instanceRequest, true, 12, []con.PodStatus{con.PodStatus{"pod123", "onap", true, corev1.PodStatus{}, []string{"10.211.1.100", "10.211.1.101"}}, con.PodStatus{"pod456", "default", true, corev1.PodStatus{}, []string{"10.211.1.100", "10.211.1.101"}}}, nil}
